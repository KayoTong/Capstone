...
export const styles = StyleSheet.create({
  container: { flex: 1, backgroundColor: '#6B7A74', padding: 30, justifyContent: 'center' },
  backButton: { position: 'absolute', top: 60, left: 25 },
  header: { marginBottom: 40 },
  title: { color: '#2ECC71', fontSize: 42, fontWeight: 'bold' },
  subtitle: { color: '#ffff', fontSize: 16, marginTop: 8 },
  form: { width: '100%'},
  inputGroup: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#e8e9eb', borderRadius: 15, marginBottom: 15, paddingHorizontal: 15, borderWidth: 1, borderColor: '#1a2e21' },
  icon: { marginRight: 10 },
