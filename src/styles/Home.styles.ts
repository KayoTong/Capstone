...
container: { flex: 1, backgroundColor: '#6B7A74' },
  ...
  alertCard: { borderRadius: 24, padding: 20, marginBottom: 25, elevation: 3, shadowColor: '#000', shadowOpacity: 0.1, shadowRadius: 10 },
  ...
  themePickerPanel: { borderRadius: 20, borderWidth: 1, padding: 12, marginTop: 15 },
  themeOptionButton: { flexDirection: 'row', alignItems: 'center', padding: 14, borderRadius: 16, marginBottom: 10, borderWidth: 1 },
  themeOptionLabel: { fontSize: 16, fontWeight: 'bold' },
  themeOptionDescription: { fontSize: 13, marginTop: 4 },
